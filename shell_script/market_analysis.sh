...
python /workspace/marketanalysis/controller/command.py optimize -i "macross.EmaCross" -ot "1458.T" -s "simple_strategy.SimpleTradingStrategy"
python /workspace/marketanalysis/controller/command.py optimize -i "rsi.Rsi" -ot "1458.T" -s "simple_strategy.SimpleTradingStrategy"
python /workspace/marketanalysis/controller/command.py optimize -i "macd.Macd" -ot "1458.T" -s "simple_strategy.SimpleTradingStrategy"
python /workspace/marketanalysis/controller/command.py optimize -i "stochastic.SlowStochastic" -ot "1458.T" -s "simple_strategy.SimpleTradingStrategy"
...
python /workspace/marketanalysis/controller/command.py optimize -i "macross.EmaCross" -ot "^VIX" -s "simple_strategy.SimpleTradingStrategy"
python /workspace/marketanalysis/controller/command.py optimize -i "rsi.Rsi" -ot "^VIX" -s "simple_strategy.SimpleTradingStrategy"
python /workspace/marketanalysis/controller/command.py optimize -i "macd.Macd" -ot "^VIX" -s "simple_strategy.SimpleTradingStrategy"
python /workspace/marketanalysis/controller/command.py optimize -i "stochastic.SlowStochastic" -ot "^VIX" -s "simple_strategy.SimpleTradingStrategy"